...
while place_order:
    ...
    if menu_category.isdigit():
        ...
        menu_selection = input("Please enter your menu selection number: ")
    ...
    if not quantity.isdigit():
        ...
        print(f"Added {quantity} {item_name}(s) to your order.")
            ...
            print(f"The selection {menu_selection} is not valid.")
    else:
        # Tell the customer that they didn't select a number
        print("Your didn't select a number.")
    else:
